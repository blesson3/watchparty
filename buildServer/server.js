...
app.get('/resolveRoom/:vanity', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (postgres === null || postgres === void 0 ? void 0 : postgres.query(`SELECT "roomId", vanity from room WHERE LOWER(vanity) = $1`, [(_m = vanity === null || vanity === void 0 ? void 0 : vanity.toLowerCase()) !== null && _m !== void 0 ? _m : '']));
...
app.get('/listRooms', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _o, _p, _q;
    const decoded = yield firebase_1.validateUserToken((_o = req.query) === null || _o === void 0 ? void 0 : _o.uid, (_p = req.query) === null || _p === void 0 ? void 0 : _p.token);
    if (!decoded) {
        return res.status(400).json({ error: 'invalid user token' });
    }
    ...
    return res.json((_q = result === null || result === void 0 ? void 0 : result.rows) !== null && _q !== void 0 ? _q : []);
}));
app.delete('/deleteRoom', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _r, _s;
    const decoded = yield firebase_1.validateUserToken((_r = req.query) === null || _r === void 0 ? void 0 : _r.uid, (_s = req.query) === null || _s === void 0 ? void 0 : _s.token);
    if (!decoded) {
        return res.status(400).json({ error: 'invalid user token' });
    }
