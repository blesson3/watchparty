...
class Room {
    constructor(io, roomId, roomData) {
        ...
        this.startVBrowser = (socket, data) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (config_1.default.STRIPE_SECRET_KEY && data && data.uid && data.token) {
                ...
                if (decoded === null || decoded === void 0 ? void 0 : decoded.email) {
                    ...
                    if ((_l = (_k = customer === null || customer === void 0 ? void 0 : customer.subscriptions) === null || _k === void 0 ? void 0 : _k.data) === null || _l === void 0 ? void 0 : _l.find((sub) => (sub === null || sub === void 0 ? void 0 : sub.status) === 'active')) {
                        console.log('found active sub for ', customer === null || customer === void 0 ? void 0 : customer.email);
                        isLarge = ((_m = data.options) === null || _m === void 0 ? void 0 : _m.size) === 'large';
                        region = (_o = data.options) === null || _o === void 0 ? void 0 : _o.region;
                    }
                }
            }
            if (config_1.default.RECAPTCHA_SECRET_KEY) {
                try {
                    ...
                    const isLowScore = ((_p = validation === null || validation === void 0 ? void 0 : validation.data) === null || _p === void 0 ? void 0 : _p.score) < 0.2;
                    const failed = ((_q = validation === null || validation === void 0 ? void 0 : validation.data) === null || _q === void 0 ? void 0 : _q.success) === false;
            ...
            (_r = this.roomRedis) === null || _r === void 0 ? void 0 : _r.disconnect();
            this.roomRedis = undefined;
            if (!assignment) {
                this.cmdHost(socket, '');
                this.vBrowser = undefined;
        ...
        this.setRoomOwner = (socket, data) => __awaiter(this, void 0, void 0, function* () {
            ...
            const customer = yield stripe_1.getCustomerByEmail(decoded.email);
            const isSubscriber = Boolean((_t = (_s = customer === null || customer === void 0 ? void 0 : customer.subscriptions) === null || _s === void 0 ? void 0 : _s.data) === null || _t === void 0 ? void 0 : _t.find((sub) => (sub === null || sub === void 0 ? void 0 : sub.status) === 'active'));
            if (data.undo) {
                ...
                const row = (_u = result === null || result === void 0 ? void 0 : result.rows) === null || _u === void 0 ? void 0 : _u[0];
        ...
        io.of(roomId).use((socket, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const password = (_x = socket.handshake.query) === null || _x === void 0 ? void 0 : _x.password;
            ...
            if (postgres) {
                ...
                const roomPassword = (_y = result.rows[0]) === null || _y === void 0 ? void 0 : _y.password;
                if (roomPassword && password !== roomPassword) {
                    next(new Error('not authorized'));
                    return;
                }
                const isSubRoom = (_z = result.rows[0]) === null || _z === void 0 ? void 0 : _z.isSubRoom;
